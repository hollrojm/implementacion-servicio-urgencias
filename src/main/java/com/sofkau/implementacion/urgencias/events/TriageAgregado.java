...
public final class TriageAgregado extends DomainEvent {
    private final TriageId triageId;
    private final CategoriaTriage categoriaTriage;
    private final Descripcion descripcion;


    public TriageAgregado(TriageId triageId, CategoriaTriage categoriaTriage, Descripcion descripcion) {
        super("hospital.urgencias.triageagregado");
